...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences(Config.MY_PREFS, Context.MODE_PRIVATE);
        Config.loggedIn = sharedPreferences.getBoolean(Config.LOGGEDIN_PREF, false);

        Log.d("status login",""+Config.loggedIn);
