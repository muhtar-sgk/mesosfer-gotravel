...
public class HomeAfterLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionManager = new SessionManager(HomeAfterLoginActivity.this);
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()){
                    ...
                    case R.id.plan_trip:
                        ...
                        fragmentTransaction8.replace(R.id.frame,planFragment);
                    ...
                    case R.id.about:
                        ...
                        fragmentTransaction9.replace(R.id.frame,aboutFragment);
